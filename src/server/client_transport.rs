...
impl std::fmt::Display for ClientMessageCloseReason {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::PixelMouse => write!(formatter, "pixel mouse report is invalid"),
        }
    }
}
...
pub(crate) fn client_message_to_event(
    ...
    let event = match message {
        ...
        ClientMessage::InputPixels {
            ...
            {
                return Err(ClientMessageCloseReason::PixelMouse);
            }
        ...
        ClientMessage::InputEvents { events } => match input_event_limit(&events) {
            ...
            InputEventLimit::InputPayloadTooLarge { size } => {
                return Err(ClientMessageCloseReason::InputPayload { size });
            }
        },
